...
if (pinstate_II_to_I != value_read_II_to_I){
    ...
    wlaczenie_II_to_I(1,127,127);
  }
  else{
    wylaczenie_II_to_I(1,127,0);
  }
...
if (pinstate_II_to_P != value_read_II_to_P){
    ...
    wlaczenie_II_to_P(3,127,127);
  }
  else{
    wylaczenie_II_to_P(3,127,0);
  }
...
if (pinstate_I_to_P != value_read_I_to_P){
    ...
    wlaczenie_I_to_P(3,127,127);
  }
  else{
   wylaczenie_I_to_P(3,127,0);
  }
